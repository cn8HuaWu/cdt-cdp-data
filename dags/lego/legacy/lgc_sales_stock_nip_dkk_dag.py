...
def load_src2stg(**kwargs):
    ...
    src2stg = Src2stgHandler(STAGING, batch_date, SRC_NAME, entity, stg_suffix, src_filename, myutil, OK_FILE_PATH, excel_fun_list=excel_fun_list, has_head=False, sheetname='Sheet1', merge =False, excel_skip_row=2, **sheet)
...
preprocess_sales_stock_nip_dkk_task = PythonOperator(
    task_id='preprocess_sales_stock_nip_dkk_task',
...
sales_stock_nip_dkk_src2stg_task = PythonOperator(
    task_id='sales_stock_nip_dkk_src2stg_task',
    provide_context=True,
...
sales_stock_nip_dkk_stg2ods_task = PythonOperator(
    task_id='sales_stock_nip_dkk_stg2ods_task',
    provide_context=True,
