...
preprocess_plan_nip_dkk_portfolio_task = PythonOperator(
    task_id = 'preprocess_plan_nip_dkk_portfolio_task',
...
plan_nip_dkk_portfolio_src2stg_task = PythonOperator(
    task_id='plan_nip_dkk_portfolio_src2stg_task',
    provide_context = True,
...
plan_nip_dkk_portfolio_stg2ods_task = PythonOperator(
    task_id='plan_nip_dkk_portfolio_stg2ods_task',
    provide_context = True,
...
preprocess_plan_nip_dkk_portfolio_task >> plan_nip_dkk_portfolio_src2stg_task >> plan_nip_dkk_portfolio_stg2ods_task >> postprocess_plan_nip_dkk_portfolio_task