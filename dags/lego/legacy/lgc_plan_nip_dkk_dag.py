...
def load_src2stg(**kwargs):
    ...
    src2stg = Src2stgHandler(STAGING, batch_date, SRC_NAME, entity, stg_suffix, src_filename, myutil, OK_FILE_PATH,
                             excel_fun_list=excel_fun_list, has_head=False, read_all=True, merge=False)
...
edw_lgc_plan_nip_dkk_create >> edw_lgc_plan_nip_dkk_insert >> postprocess_plan_nip_dkk_task
