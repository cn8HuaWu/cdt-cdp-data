...
entity = 'store_renovation_record'
src_entity = 'lgc_store_renovation_record'
...
preprocess_store_renovation_record_task = PythonOperator(
    task_id='preprocess_store_renovation_record_task',
...
store_renovation_record_src2stg_task = PythonOperator(
    task_id='store_renovation_record_src2stg_task',
    provide_context=True,
...
store_renovation_record_stg2ods_task = PythonOperator(
    task_id='store_renovation_record_stg2ods_task',
    provide_context=True,
...
edw_lgc_store_renovation_list_create = PythonOperator(
    task_id='edw_lgc_store_renovation_list_create',
    provide_context=True,
    python_callable=update_downstream,
    op_kwargs={'myutil': myutil, 'gpdb': db, 'sql_file_name': "lgc_store_renovation_record",
...
edw_lgc_store_renovation_list_insert = PythonOperator(
    task_id='edw_lgc_store_renovation_list_insert',
    provide_context=True,
    python_callable=update_downstream,
    op_kwargs={'myutil': myutil, 'gpdb': db, 'sql_file_name': "lgc_store_renovation_record",
...
preprocess_store_renovation_record_task >> store_renovation_record_src2stg_task >> store_renovation_record_stg2ods_task >> edw_lgc_store_renovation_list_create
edw_lgc_store_renovation_list_create >> edw_lgc_store_renovation_list_insert >> postprocess_store_renovation_record_task
