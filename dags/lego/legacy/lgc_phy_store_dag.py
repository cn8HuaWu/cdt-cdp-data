...
def load_src2stg(**kwargs):
    ...
    src2stg = Src2stgHandler(STAGING, batch_date, SRC_NAME, entity, stg_suffix, src_filename, myutil, OK_FILE_PATH, excel_fun_list=excel_fun_list, has_head=False, sheetname = 'Store_Master_Data', merge = False)
...
preprocess_phy_store_task = PythonOperator(
    task_id = 'preprocess_phy_store_task',
...
phy_store_src2stg_task = PythonOperator(
    task_id='phy_store_src2stg_task',
    provide_context = True,
