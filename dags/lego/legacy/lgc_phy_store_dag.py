...
def load_src2stg(**kwargs):
    ...
    src2stg = Src2stgHandler(STAGING, batch_date, SRC_NAME, entity, stg_suffix, src_filename, myutil, OK_FILE_PATH,
                             excel_fun_list=excel_fun_list, has_head=False, sheetname='Store_Master_Data', merge=True)
...
edw_lgc_phy_store_create >> edw_lgc_phy_store_delete >> edw_lgc_phy_store_insert >> postprocess_phy_store_task
