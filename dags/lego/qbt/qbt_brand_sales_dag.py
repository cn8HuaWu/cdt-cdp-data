...
entity = 'brand_sales'
src_entity = 'qbt_brand_sales'
DAG_NAME = 'qbt_brand_sales_dag'
...
preprocess_brand_sales_task = PythonOperator(
    task_id = 'preprocess_brand_sales_task',
...
brand_sales_src2stg_task = PythonOperator(
    task_id='brand_sales_src2stg_task',
    provide_context = True,
...
brand_sales_stg2ods_task = PythonOperator(
    task_id='brand_sales_stg2ods_task',
    provide_context = True,
...
brand_sales_ods2edw_task = PythonOperator(
    task_id='brand_sales_ods2edw_task',
    provide_context = True,
...
postprocess_brand_sales_task = PythonOperator(
    task_id = 'postprocess_brand_sales_task',
    provide_context = True,
...
preprocess_brand_sales_task >> brand_sales_src2stg_task >> brand_sales_stg2ods_task >>  brand_sales_ods2edw_task  >>  postprocess_brand_sales_task
