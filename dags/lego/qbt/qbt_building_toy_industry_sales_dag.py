...
entity = 'building_toy_industry_sales'
src_entity = 'qbt_building_toy_industry_sales'
DAG_NAME = 'qbt_building_toy_industry_sales_dag'
...
def load_ods2edw(**kwargs):
    ...
    #
    ods2edw = Ods2edwHandler(  batch_date, SRC_NAME, entity, pkey,table_prefix, myutil, db, update_type=update_type, has_param=True, trunc_before_load= False )
    ods2edw.start()
...
preprocess_building_toy_industry_sales_task = PythonOperator(
    task_id = 'preprocess_building_toy_industry_sales_task',
...
building_toy_industry_sales_src2stg_task = PythonOperator(
    task_id='building_toy_industry_sales_src2stg_task',
    provide_context = True,
...
building_toy_industry_sales_stg2ods_task = PythonOperator(
    task_id='building_toy_industry_sales_stg2ods_task',
    provide_context = True,
...
building_toy_industry_sales_ods2edw_task = PythonOperator(
    task_id='building_toy_industry_sales_ods2edw_task',
    provide_context = True,
...
postprocess_building_toy_industry_sales_task = PythonOperator(
    task_id = 'postprocess_building_toy_industry_sales_task',
    provide_context = True,
...
preprocess_building_toy_industry_sales_task >> building_toy_industry_sales_src2stg_task >> building_toy_industry_sales_stg2ods_task >>  building_toy_industry_sales_ods2edw_task  >>  postprocess_building_toy_industry_sales_task
