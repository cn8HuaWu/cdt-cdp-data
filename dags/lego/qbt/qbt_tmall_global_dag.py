...
entity = 'tmall_global'
src_entity = 'qbt_tmall_global'
DAG_NAME = 'qbt_tmall_global_dag'
...
preprocess_tmall_global_task = PythonOperator(
    task_id = 'preprocess_tmall_global_task',
...
tmall_global_src2stg_task = PythonOperator(
    task_id='tmall_global_src2stg_task',
    provide_context = True,
...
tmall_global_stg2ods_task = PythonOperator(
    task_id='tmall_global_stg2ods_task',
    provide_context = True,
...
tmall_global_ods2edw_task = PythonOperator(
    task_id='tmall_global_ods2edw_task',
    provide_context = True,
...
postprocess_tmall_global_task = PythonOperator(
    task_id = 'postprocess_tmall_global_task',
    provide_context = True,
...
preprocess_tmall_global_task >> tmall_global_src2stg_task >> tmall_global_stg2ods_task >>  tmall_global_ods2edw_task  >>  postprocess_tmall_global_task
