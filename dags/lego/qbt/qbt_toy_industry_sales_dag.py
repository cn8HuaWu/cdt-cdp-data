...
entity = 'toy_industry_sales'
src_entity = 'qbt_toy_industry_sales'
DAG_NAME = 'qbt_toy_industry_sales_dag'
...
preprocess_toy_industry_sales_task = PythonOperator(
    task_id = 'preprocess_toy_industry_sales_task',
...
toy_industry_sales_src2stg_task = PythonOperator(
    task_id='toy_industry_sales_src2stg_task',
    provide_context = True,
...
toy_industry_sales_stg2ods_task = PythonOperator(
    task_id='toy_industry_sales_stg2ods_task',
    provide_context = True,
...
toy_industry_sales_ods2edw_task = PythonOperator(
    task_id='toy_industry_sales_ods2edw_task',
    provide_context = True,
...
postprocess_toy_industry_sales_task = PythonOperator(
    task_id = 'postprocess_toy_industry_sales_task',
    provide_context = True,
...
preprocess_toy_industry_sales_task >> toy_industry_sales_src2stg_task >> toy_industry_sales_stg2ods_task >>  toy_industry_sales_ods2edw_task  >>  postprocess_toy_industry_sales_task
