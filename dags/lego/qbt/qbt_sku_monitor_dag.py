...
entity = 'sku_monitor'
src_entity = 'qbt_sku_monitor'
DAG_NAME = 'qbt_sku_monitor_dag'
...
preprocess_sku_monitor_task = PythonOperator(
    task_id = 'preprocess_sku_monitor_task',
...
sku_monitor_src2stg_task = PythonOperator(
    task_id='sku_monitor_src2stg_task',
    provide_context = True,
...
sku_monitor_stg2ods_task = PythonOperator(
    task_id='sku_monitor_stg2ods_task',
    provide_context = True,
...
sku_monitor_ods2edw_task = PythonOperator(
    task_id='sku_monitor_ods2edw_task',
    provide_context = True,
...
postprocess_sku_monitor_task = PythonOperator(
    task_id = 'postprocess_sku_monitor_task',
    provide_context = True,
...
preprocess_sku_monitor_task >> sku_monitor_src2stg_task >> sku_monitor_stg2ods_task >>  sku_monitor_ods2edw_task >>  postprocess_sku_monitor_task
