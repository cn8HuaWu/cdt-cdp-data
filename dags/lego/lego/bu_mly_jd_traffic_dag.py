...
entity = 'mly_jd_traffic'
src_entity = 'bu_mly_jd_traffic'
DAG_NAME = 'bu_mly_jd_traffic_dag'
...
def b_choice(**kwargs):
    if ("skip_load"  in kwargs.get('dag_run').conf 
        and kwargs.get('dag_run').conf.get("skip_load").upper() == 'Y' ):
        return "mly_jd_traffic_dummy"
    else:
        return "preprocess_mly_jd_traffic_task"
...
# branch_skip_load_mly_jd_traffic = BranchPythonOperator(
#     task_id='branch_skip_load_mly_jd_traffic',
#     python_callable= b_choice,
#     provide_context = True,
#     dag=dag,
# )

# mly_jd_traffic_dummy = DummyOperator(
#     task_id="mly_jd_traffic_dummy",
#     dag=dag,
# )

preprocess_mly_jd_traffic_task = PythonOperator(
    task_id = 'preprocess_mly_jd_traffic_task',
    provide_context = True,
...
mly_jd_traffic_src2stg_task = PythonOperator(
    task_id='mly_jd_traffic_src2stg_task',
    provide_context = True,
...
mly_jd_traffic_stg2ods_task = PythonOperator(
    task_id='mly_jd_traffic_stg2ods_task',
    provide_context = True,
...
mly_jd_traffic_ods2edw_task = PythonOperator(
    task_id='mly_jd_traffic_ods2edw_task',
    provide_context = True,
...
# mly_jd_traffic_update_dl_mly_sales_rpt = PythonOperator(
#     task_id='mly_jd_traffic_update_dl_mly_sales_rpt',
#     provide_context = True,
...
mly_jd_traffic_sync_2_rds_task = SubDagOperator(
    task_id='mly_jd_traffic_sync_2_rds_task',
    subdag=sync_subdag(DAG_NAME, 'mly_jd_traffic_sync_2_rds_task', myutil, entity_conf, args, entity),
    default_args=args,
...
postprocess_mly_jd_traffic_task = PythonOperator(
    task_id = 'postprocess_mly_jd_traffic_task',
    provide_context = True,
...
# branch_skip_load_mly_jd_traffic >> mly_jd_traffic_dummy >> mly_jd_traffic_update_dl_mly_sales_rpt
# branch_skip_load_mly_jd_traffic >> preprocess_mly_jd_traffic_task
preprocess_mly_jd_traffic_task >> mly_jd_traffic_src2stg_task >> mly_jd_traffic_stg2ods_task >> mly_jd_traffic_ods2edw_task
mly_jd_traffic_ods2edw_task  >> mly_jd_traffic_sync_2_rds_task >> postprocess_mly_jd_traffic_task
