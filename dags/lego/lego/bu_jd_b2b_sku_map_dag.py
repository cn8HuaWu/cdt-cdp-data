...
entity = 'jd_b2b_sku_map'
src_entity = 'bu_jd_b2b_sku_map'
DAG_NAME = 'bu_jd_b2b_sku_map_dag'
...
def b_choice(**kwargs):
    if ("skip_load"  in kwargs.get('dag_run').conf 
        and kwargs.get('dag_run').conf.get("skip_load").upper() == 'Y' ):
        return "jd_b2b_sku_map_dummy"
    else:
        return "preprocess_jd_b2b_sku_map_task"
...
branch_skip_load_jd_b2b_sku_map = BranchPythonOperator(
    task_id='branch_skip_load_jd_b2b_sku_map',
    python_callable= b_choice,
    provide_context = True,
    dag=dag,
)

jd_b2b_sku_map_dummy = DummyOperator(
    task_id="jd_b2b_sku_map_dummy",
    dag=dag,
)

preprocess_jd_b2b_sku_map_task = PythonOperator(
    task_id = 'preprocess_jd_b2b_sku_map_task',
    provide_context = True,
...
jd_b2b_sku_map_src2stg_task = PythonOperator(
    task_id='jd_b2b_sku_map_src2stg_task',
    provide_context = True,
...
jd_b2b_sku_map_stg2ods_task = PythonOperator(
    task_id='jd_b2b_sku_map_stg2ods_task',
    provide_context = True,
...
jd_b2b_sku_map_ods2edw_task = PythonOperator(
    task_id='jd_b2b_sku_map_ods2edw_task',
    provide_context = True,
...
# jd_b2b_sku_map_update_product_info = PythonOperator(
#     task_id='jd_b2b_sku_map_update_product_info',
#     provide_context = True,
...
b2b_sku_map_update_b2b_order_dtl = PythonOperator(
    task_id='b2b_sku_map_update_b2b_order_dtl',
    provide_context = True,
    python_callable = update_downstream,
...
b2b_sku_map_update_dl_order_dtl = PythonOperator(
    task_id='b2b_sku_map_update_dl_order_dtl',
    provide_context = True,
    python_callable = update_downstream,
...
b2b_sku_map_update_b2b_order = PythonOperator(
    task_id='b2b_sku_map_update_b2b_order',
    provide_context = True,
    python_callable = update_downstream,
...
b2b_sku_map_update_dl_jd_order = PythonOperator(
    task_id='b2b_sku_map_update_dl_jd_order',
    provide_context = True,
    python_callable = update_downstream,
...
b2b_sku_map_update_dly_sales_rpt = PythonOperator(
    task_id='b2b_sku_map_update_dly_sales_rpt',
    provide_context = True,
    python_callable = update_downstream,
...
# b2b_sku_map_update_mly_sales_rpt = PythonOperator(
#     task_id='b2b_sku_map_update_mly_sales_rpt',
#     provide_context = True,
#     python_callable = update_downstream,
...
b2b_sku_map_update_dl_shopper = PythonOperator(
    task_id='b2b_sku_map_update_dl_shopper',
    provide_context = True,
    python_callable = update_downstream,
...
jd_b2b_sku_map_sync_2_rds_task = SubDagOperator(
    task_id='jd_b2b_sku_map_sync_2_rds_task',
    subdag=sync_subdag(DAG_NAME, 'jd_b2b_sku_map_sync_2_rds_task', myutil, entity_conf, args, entity),
    default_args=args,
...
postprocess_jd_b2b_sku_map_task = PythonOperator(
    task_id = 'postprocess_jd_b2b_sku_map_task',
    provide_context = True,
...
branch_skip_load_jd_b2b_sku_map >> jd_b2b_sku_map_dummy
branch_skip_load_jd_b2b_sku_map >> preprocess_jd_b2b_sku_map_task
# jd_b2b_sku_map_dummy >> jd_b2b_sku_map_update_product_info
# jd_b2b_sku_map_dummy >> jd_b2b_sku_map_update_product_info >> b2b_sku_map_update_b2b_order_dtl
preprocess_jd_b2b_sku_map_task >> jd_b2b_sku_map_src2stg_task >> jd_b2b_sku_map_stg2ods_task >> jd_b2b_sku_map_ods2edw_task >> b2b_sku_map_update_b2b_order_dtl
# jd_b2b_sku_map_ods2edw_task >> jd_b2b_sku_map_update_product_info >> jd_b2b_sku_map_sync_2_rds_task >> postprocess_jd_b2b_sku_map_task
jd_b2b_sku_map_dummy >> b2b_sku_map_update_b2b_order_dtl >> b2b_sku_map_update_dl_order_dtl 
b2b_sku_map_update_dl_order_dtl >> b2b_sku_map_update_dly_sales_rpt >> jd_b2b_sku_map_sync_2_rds_task >> postprocess_jd_b2b_sku_map_task
# b2b_sku_map_update_dl_order_dtl >> b2b_sku_map_update_mly_sales_rpt >> jd_b2b_sku_map_sync_2_rds_task >> postprocess_jd_b2b_sku_map_task
b2b_sku_map_update_b2b_order_dtl >> b2b_sku_map_update_b2b_order >> b2b_sku_map_update_dl_jd_order >> jd_b2b_sku_map_sync_2_rds_task >> postprocess_jd_b2b_sku_map_task

b2b_sku_map_update_dl_order_dtl >> b2b_sku_map_update_dl_shopper >> jd_b2b_sku_map_sync_2_rds_task >> postprocess_jd_b2b_sku_map_task