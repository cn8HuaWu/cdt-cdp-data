...
entity = 'jd_b2b_gwp'
src_entity = 'bu_jd_b2b_gwp'
email_to_list =  Variable.get('email_to_list').split(',')
DAG_NAME = 'bu_jd_b2b_gwp_dag'
...
branch_skip_load_jd_b2b_gwp_map = BranchPythonOperator(
    task_id='branch_skip_load_jd_b2b_gwp_map',
    python_callable= b_choice,
    provide_context = True,
    dag=dag,
)

jd_b2b_gwp_map_dummy = DummyOperator(
    task_id="jd_b2b_gwp_map_dummy",
    dag=dag,
)

preprocess_jd_b2b_gwp_map_task = PythonOperator(
    task_id = 'preprocess_jd_b2b_gwp_map_task',
    provide_context = True,
...
jd_b2b_gwp_map_src2stg_task = PythonOperator(
    task_id='jd_b2b_gwp_map_src2stg_task',
    provide_context = True,
...
jd_b2b_gwp_map_stg2ods_task = PythonOperator(
    task_id='jd_b2b_gwp_map_stg2ods_task',
    provide_context = True,
...
jd_b2b_gwp_map_ods2edw_task = PythonOperator(
    task_id='jd_b2b_gwp_map_ods2edw_task',
    provide_context = True,
...
b2b_gwp_update_b2b_order_dtl = PythonOperator(
    task_id='b2b_gwp_update_b2b_order_dtl',
    provide_context = True,
...
b2b_gwp_update_dl_order_dtl = PythonOperator(
    task_id='b2b_gwp_update_dl_order_dtl',
    provide_context = True,
    python_callable = update_downstream,
...
b2b_gwp_update_b2b_order = PythonOperator(
    task_id='b2b_gwp_update_b2b_order',
    provide_context = True,
    python_callable = update_downstream,
...
b2b_gwp_update_dly_sales_rpt = PythonOperator(
    task_id='b2b_gwp_update_dly_sales_rpt',
    provide_context = True,
    python_callable = update_downstream,
...
# b2b_gwp_update_mly_sales_rpt = PythonOperator(
#     task_id='b2b_gwp_update_mly_sales_rpt',
#     provide_context = True,
#     python_callable = update_downstream,
...
b2b_gwp_update_dl_jd_order = PythonOperator(
    task_id='b2b_gwp_update_dl_jd_order',
    provide_context = True,
    python_callable = update_downstream,
...
b2b_gwp_update_dl_shopper = PythonOperator(
    task_id='b2b_gwp_update_dl_shopper',
    provide_context = True,
    python_callable = update_downstream,
...
b2b_gwp_map_sync_2_rds_task = SubDagOperator(
    task_id='b2b_gwp_map_sync_2_rds_task',
    subdag=sync_subdag(DAG_NAME, 'b2b_gwp_map_sync_2_rds_task', myutil, entity_conf, args, entity),
    default_args=args,
...
postprocess_jd_b2b_gwp_map_task = PythonOperator(
    task_id = 'postprocess_jd_b2b_gwp_map_task',
    provide_context = True,
...
branch_skip_load_jd_b2b_gwp_map >> jd_b2b_gwp_map_dummy >> b2b_gwp_update_b2b_order_dtl
branch_skip_load_jd_b2b_gwp_map >> preprocess_jd_b2b_gwp_map_task
preprocess_jd_b2b_gwp_map_task >> jd_b2b_gwp_map_src2stg_task >> jd_b2b_gwp_map_stg2ods_task >> jd_b2b_gwp_map_ods2edw_task
jd_b2b_gwp_map_ods2edw_task >>b2b_gwp_update_b2b_order_dtl >>  b2b_gwp_update_b2b_order >> b2b_gwp_update_dl_jd_order >> b2b_gwp_update_dl_shopper >> b2b_gwp_map_sync_2_rds_task >> postprocess_jd_b2b_gwp_map_task
b2b_gwp_update_b2b_order_dtl >> b2b_gwp_update_dl_order_dtl 
b2b_gwp_update_dl_order_dtl >> b2b_gwp_update_dly_sales_rpt >> b2b_gwp_map_sync_2_rds_task >> postprocess_jd_b2b_gwp_map_task
# b2b_gwp_update_dl_order_dtl >> b2b_gwp_update_mly_sales_rpt >> b2b_gwp_map_sync_2_rds_task >> postprocess_jd_b2b_gwp_map_task