...
entity = 'jd_pop_gwp'
src_entity = 'bu_jd_pop_gwp'
DAG_NAME = 'bu_jd_pop_gwp_dag'
...
def b_choice(**kwargs):
    if ("skip_load"  in kwargs.get('dag_run').conf 
        and kwargs.get('dag_run').conf.get("skip_load").upper() == 'Y' ):
        return "jd_pop_gwp_map_dummy"
    else:
        return "preprocess_jd_pop_gwp_map_task"
...
branch_skip_load_jd_pop_gwp_map = BranchPythonOperator(
    task_id='branch_skip_load_jd_pop_gwp_map',
    python_callable= b_choice,
    provide_context = True,
    dag=dag,
)

jd_pop_gwp_map_dummy = DummyOperator(
    task_id="jd_pop_gwp_map_dummy",
    dag=dag,
)

preprocess_jd_pop_gwp_map_task = PythonOperator(
    task_id = 'preprocess_jd_pop_gwp_map_task',
    provide_context = True,
...
jd_pop_gwp_map_src2stg_task = PythonOperator(
    task_id='jd_pop_gwp_map_src2stg_task',
    provide_context = True,
...
jd_pop_gwp_map_stg2ods_task = PythonOperator(
    task_id='jd_pop_gwp_map_stg2ods_task',
    provide_context = True,
...
jd_pop_gwp_map_ods2edw_task = PythonOperator(
    task_id='jd_pop_gwp_map_ods2edw_task',
    provide_context = True,
...
pop_gwp_update_pop_order_dtl = PythonOperator(
    task_id='pop_gwp_update_pop_order_dtl',
    provide_context = True,
...
pop_gwp_update_dl_order_dtl = PythonOperator(
    task_id='pop_gwp_update_dl_order_dtl',
    provide_context = True,
    python_callable = update_downstream,
...
pop_gwp_update_pop_order = PythonOperator(
    task_id='pop_gwp_update_pop_order',
    provide_context = True,
    python_callable = update_downstream,
...
pop_gwp_update_dl_jd_order = PythonOperator(
    task_id='pop_gwp_update_dl_jd_order',
    provide_context = True,
    python_callable = update_downstream,
...
pop_gwp_update_dly_sales_rpt = PythonOperator(
...
# pop_gwp_update_mly_sales_rpt = PythonOperator(
#     task_id='pop_gwp_update_mly_sales_rpt',
#     provide_context = True,
#     python_callable = update_downstream,
...
pop_gwp_update_dl_shopper = PythonOperator(
    task_id='pop_gwp_update_dl_shopper',
    provide_context = True,
    python_callable = update_downstream,
...
pop_gwp_map_sync_2_rds_task = SubDagOperator(
    task_id='pop_gwp_map_sync_2_rds_task',
    subdag=sync_subdag(DAG_NAME, 'pop_gwp_map_sync_2_rds_task', myutil, entity_conf, args, entity),
    default_args=args,
...
postprocess_jd_pop_gwp_map_task = PythonOperator(
    task_id = 'postprocess_jd_pop_gwp_map_task',
    provide_context = True,
...
branch_skip_load_jd_pop_gwp_map >> jd_pop_gwp_map_dummy >> pop_gwp_update_pop_order_dtl
branch_skip_load_jd_pop_gwp_map >> preprocess_jd_pop_gwp_map_task
preprocess_jd_pop_gwp_map_task >> jd_pop_gwp_map_src2stg_task >> jd_pop_gwp_map_stg2ods_task >> jd_pop_gwp_map_ods2edw_task
jd_pop_gwp_map_ods2edw_task >> pop_gwp_update_pop_order_dtl >> pop_gwp_update_pop_order >> pop_gwp_update_dl_jd_order >> pop_gwp_update_dl_shopper  >> pop_gwp_map_sync_2_rds_task >> postprocess_jd_pop_gwp_map_task
pop_gwp_update_pop_order_dtl >> pop_gwp_update_dl_order_dtl 
pop_gwp_update_dl_order_dtl >> pop_gwp_update_dly_sales_rpt >> pop_gwp_map_sync_2_rds_task >> postprocess_jd_pop_gwp_map_task
# pop_gwp_update_dl_order_dtl >> pop_gwp_update_mly_sales_rpt >> pop_gwp_map_sync_2_rds_task >> postprocess_jd_pop_gwp_map_task
