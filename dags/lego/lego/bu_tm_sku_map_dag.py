...
entity = 'tm_sku_map'
src_entity = 'bu_tm_sku_map'
DAG_NAME = 'bu_tm_sku_map_dag'
...
def b_choice(**kwargs):
    if ("skip_load"  in kwargs.get('dag_run').conf 
        and kwargs.get('dag_run').conf.get("skip_load").upper() == 'Y' ):
        return "tm_sku_map_dummy"
    else:
        return "preprocess_tm_sku_map_task"
...
branch_skip_load_tm_sku_map = BranchPythonOperator(
    task_id='branch_skip_load_tm_sku_map',
    python_callable= b_choice,
    provide_context = True,
    dag=dag,
)

tm_sku_map_dummy = DummyOperator(
    task_id="tm_sku_map_dummy",
    dag=dag,
)

preprocess_tm_sku_map_task = PythonOperator(
    task_id = 'preprocess_tm_sku_map_task',
    provide_context = True,
...
tm_sku_map_src2stg_task = PythonOperator(
    task_id='tm_sku_map_src2stg_task',
    provide_context = True,
...
tm_sku_map_stg2ods_task = PythonOperator(
    task_id='tm_sku_map_stg2ods_task',
    provide_context = True,
...
tm_sku_map_ods2edw_task = PythonOperator(
    task_id='tm_sku_map_ods2edw_task',
    provide_context = True,
...
# tm_sku_map_update_product_info = PythonOperator(
#     task_id='tm_sku_map_update_product_info',
#     provide_context = True,
...
tm_sku_map_update_oms_order_dtl = PythonOperator(
    task_id='tm_sku_map_update_oms_order_dtl',
    provide_context = True,
    python_callable = update_downstream,
...
tm_sku_map_update_dly_sales_rpt = PythonOperator(
    task_id='tm_sku_map_update_dly_sales_rpt',
    provide_context = True,
    python_callable = update_downstream,
...
# tm_sku_map_update_mly_sales_rpt = PythonOperator(
#     task_id='tm_sku_map_update_mly_sales_rpt',
#     provide_context = True,
#     python_callable = update_downstream,
...
tm_sku_map_sync_2_rds_task = SubDagOperator(
    ...
    subdag=sync_subdag(DAG_NAME, 'tm_sku_map_sync_2_rds_task', myutil, entity_conf, args, entity),
    default_args=args,
...
postprocess_tm_sku_map_task = PythonOperator(
    task_id = 'postprocess_tm_sku_map_task',
    provide_context = True,
...
# preprocess_tm_sku_map_task >> tm_sku_map_src2stg_task >> tm_sku_map_stg2ods_task >> tm_sku_map_ods2edw_task 
# tm_sku_map_ods2edw_task >> tm_sku_map_update_product_info >> tm_sku_map_sync_2_rds_task >> postprocess_tm_sku_map_task
# tm_sku_map_ods2edw_task >> tm_sku_map_update_oms_order_dtl >> tm_sku_map_update_dly_sales_rpt >> tm_sku_map_sync_2_rds_task >> postprocess_tm_sku_map_task
# tm_sku_map_update_oms_order_dtl >> tm_sku_map_update_mly_sales_rpt >>  tm_sku_map_sync_2_rds_task >> postprocess_tm_sku_map_task
# tm_sku_map_update_oms_order_dtl >> tm_sku_map_update_oms_order >> tm_sku_map_sync_2_rds_task >> postprocess_tm_sku_map_task

branch_skip_load_tm_sku_map >> tm_sku_map_dummy >> tm_sku_map_update_oms_order_dtl
branch_skip_load_tm_sku_map >> preprocess_tm_sku_map_task
