...
DAG_NAME = 'dl_api_extract_jd_member_dag'
src_entity = 'jd_member'
api_interval = Variable.get('interval_jd_api').strip()
dag_start_date = Variable.get('dag_start_date').strip()
data_timedelta = int(Variable.get('jd_member_data_timedelta').strip())
jd_load_timedelta = int(Variable.get('jd_member_load_timedelta').strip())
...
extract_jd_member_task = PythonOperator(
    task_id='extract_jd_member_task',
