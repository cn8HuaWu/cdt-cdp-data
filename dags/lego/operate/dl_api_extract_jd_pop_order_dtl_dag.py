...
DAG_NAME = 'dl_api_extract_jd_pop_order_dtl_dag'
src_entity = 'jd_pop_order_dtl'
api_interval = Variable.get('interval_jd_pop_detail_api').strip()
...
extract_jd_pop_order_dtl_task = PythonOperator(
    task_id='extract_jd_pop_order_dtl_task',
