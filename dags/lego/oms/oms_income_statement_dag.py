...
src_entity = 'oms_income_statement'
DAG_NAME = 'oms_income_statement_dag'
...
lego_hr_subject = Variable.get('lego_hr_subject').strip() + "-INCOME STATEMENT" 
lego_hr_html_content =  "INCOME STATEMENT " + Variable.get('lego_hr_html_content').strip() 
lego_hr_html_content_premail =  "INCOME STATEMENT Starts running" 
...
def premail_or_not(**kwargs):
    ...
    if hour >= hr_work_time:
        ...
        return "oms_income_statement_stg2ods_task"
...
args = {
    ...
    'retries': 0,
    "src_name": SRC_NAME,
    "batch_date_args": 'oms_income_statement_stg2ods_task',
}
...
oms_income_statement_stg2ods_task = PythonOperator(
    task_id='oms_income_statement_stg2ods_task',
...
oms_income_statement_ods2edw_task = PythonOperator(
    task_id='oms_income_statement_ods2edw_task',
    provide_context = True,
...
income_expense_sensor_task >> check_datahub_branch_task >> premail_or_not_branch_task >> income_expense_premail_task >> oms_income_statement_stg2ods_task >> oms_income_statement_ods2edw_task >> income_expense_sync_2_rds_task >> mail_or_not_branch_task >> income_expense_email_task >> postprocess_income_expense_task
premail_or_not_branch_task >> oms_income_statement_stg2ods_task
