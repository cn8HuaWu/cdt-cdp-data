...
entity = 'return_order'
src_entity = 'oms_return_order'
DAG_NAME = 'oms_return_order_dag'
...
api_interval = Variable.get('interval_oms_return_order').strip()
...
def load_ods2edw(**kwargs):
    ...
    #
    my_batch_date = kwargs['task_instance'].xcom_pull(key='batch_date', task_ids='oms_return_order_stg2ods_task')
    ods2edw = Ods2edwHandler( 
        my_batch_date, 
        SRC_NAME, 
        entity, 
        pkey,
...
args = {
    ...
    'retries': 0,
    "src_name": SRC_NAME,
    "batch_date_args": 'oms_return_order_stg2ods_task'
}
...
oms_return_order_stg2ods_task = PythonOperator(
    task_id='oms_return_order_stg2ods_task',
...
oms_return_order_ods2edw_task = PythonOperator(
    task_id='oms_return_order_ods2edw_task',
    provide_context = True,
...
# oms_return_order_post_update_task = SubDagOperator(
#     task_id='oms_return_order_post_update_task',
#     subdag=update_subdag(DAG_NAME, 'oms_return_order_post_update_task', myutil, db,  args),
#     default_args=args,
...
postprocess_oms_return_order_task = PythonOperator(
    task_id = 'postprocess_oms_return_order_task',
    provide_context = True,
...
oms_return_order_stg2ods_task >>  oms_return_order_ods2edw_task >>  postprocess_oms_return_order_task