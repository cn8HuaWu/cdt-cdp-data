...
entity = 'pop_order'
src_entity = 'jd_pop_order'
DAG_NAME = 'jd_pop_order_dag'
...
def post_process_fileload( **kwargs ):
    ...
    # myutil.send_success_mail(context)
...
def b_choice(**kwargs):
    if ("skip_load"  in kwargs.get('dag_run').conf 
        and kwargs.get('dag_run').conf.get("skip_load").upper() == 'Y' ):
        return "pop_order_dummy"
    else:
        return "preprocess_pop_order_task"
...
branch_skip_load_pop_order = BranchPythonOperator(
    task_id='branch_skip_load_pop_order',
    python_callable= b_choice,
    provide_context = True,
    dag=dag,
)

pop_order_dummy = DummyOperator(
    task_id="pop_order_dummy",
    dag=dag,
)

preprocess_pop_order_task = PythonOperator(
    task_id = 'preprocess_pop_order_task',
    provide_context = True,
...
pop_order_src2stg_task = PythonOperator(
    task_id='pop_order_src2stg_task',
    provide_context = True,
...
pop_order_stg2ods_task = PythonOperator(
    task_id='pop_order_stg2ods_task',
    provide_context = True,
...
pop_order_ods2edw_task = PythonOperator(
    task_id='pop_order_ods2edw_task',
    provide_context = True,
...
pop_order_update_jd_member = PythonOperator(
    task_id='pop_order_update_jd_member',
    provide_context = True,
...
pop_order_updated_by_consignee = PythonOperator(
    task_id='pop_order_updated_by_consignee',
    provide_context = True,
    python_callable = update_downstream,
    op_kwargs = {'myutil':myutil, 'gpdb': db, 'sql_file_name':"jd_pop_order" , 'sql_section': 'update_by_consignee', 'args': args},
    on_failure_callback = dag_failure_handler,
    trigger_rule='none_failed',
    dag=dag,
)

pop_order_updated_by_pop_order_dtl = PythonOperator(
    task_id='pop_order_updated_by_pop_order_dtl',
    provide_context = True,
    python_callable = update_downstream,
...
pop_order_update_pop_order_dtl = PythonOperator(
    task_id='pop_order_update_pop_order_dtl',
    provide_context = True,
    python_callable = update_downstream,
...
pop_order_update_b2b_order_dtl = PythonOperator(
    task_id='pop_order_update_b2b_order_dtl',
    provide_context = True,
    python_callable = update_downstream,
...
pop_order_update_b2b_order= PythonOperator(
    task_id='pop_order_update_b2b_order',
    provide_context = True,
    python_callable = update_downstream,
...
pop_order_update_dl_order_dtl = PythonOperator(
    task_id='pop_order_update_dl_order_dtl',
    provide_context = True,
    python_callable = update_downstream,
...
pop_order_update_dl_shopper = PythonOperator(
    task_id='pop_order_update_dl_shopper',
    provide_context = True,
    python_callable = update_downstream,
...
pop_order_update_dl_order = PythonOperator(
    task_id='pop_order_update_dl_order',
    provide_context = True,
    python_callable = update_downstream,
...
pop_order_update_dly_sales_rpt = PythonOperator(
    task_id='pop_order_update_dly_sales_rpt',
    provide_context = True,
    python_callable = update_downstream,
...
# pop_order_update_mly_sales_rpt = PythonOperator(
#     task_id='pop_order_update_mly_sales_rpt',
#     provide_context = True,
#     python_callable = update_downstream,
...
pop_order_sync_2_rds_task = SubDagOperator(
    task_id='pop_order_sync_2_rds_task',
    subdag=sync_subdag(DAG_NAME, 'pop_order_sync_2_rds_task', myutil, entity_conf, args, entity),
    default_args=args,
...
postprocess_jd_order_info_task = PythonOperator(
    task_id = 'postprocess_jd_order_info_task',
    provide_context = True,
...
branch_skip_load_pop_order >> pop_order_dummy
branch_skip_load_pop_order >> preprocess_pop_order_task
preprocess_pop_order_task >> pop_order_src2stg_task >> pop_order_stg2ods_task >> pop_order_ods2edw_task

pop_order_dummy >> pop_order_update_jd_member 
pop_order_ods2edw_task >> pop_order_update_jd_member >> pop_order_update_b2b_order_dtl >> pop_order_update_dl_order_dtl 
pop_order_update_b2b_order_dtl >> pop_order_update_b2b_order >> pop_order_update_dl_order 

pop_order_dummy >> pop_order_updated_by_consignee
pop_order_ods2edw_task >> pop_order_updated_by_consignee >> pop_order_updated_by_pop_order_dtl >> pop_order_update_pop_order_dtl >> pop_order_update_dl_order_dtl
pop_order_update_dl_order_dtl >> pop_order_update_dly_sales_rpt >> pop_order_sync_2_rds_task
# pop_order_update_dl_order_dtl >> pop_order_update_mly_sales_rpt >> pop_order_sync_2_rds_task

pop_order_updated_by_pop_order_dtl >> pop_order_update_dl_order >> pop_order_update_dl_shopper >> pop_order_sync_2_rds_task
pop_order_sync_2_rds_task >> postprocess_jd_order_info_task
