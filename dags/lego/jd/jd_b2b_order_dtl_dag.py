...
entity = 'b2b_order_dtl'
src_entity = 'jd_b2b_order_dtl'
DAG_NAME = 'jd_b2b_order_dtl_dag'
...
def b_choice(**kwargs):
    ...
    if ("skip_load"  in kwargs.get('dag_run').conf 
        and kwargs.get('dag_run').conf.get("skip_load").upper() == 'Y' ):
        return "b2b_order_dtl_dummy"
    else:
        return "preprocess_b2b_order_dtl_task"
...
b2b_order_dtl_dummy = DummyOperator(
        task_id="b2b_order_dtl_dummy",
        dag=dag,
    )

preprocess_b2b_order_dtl_task = PythonOperator(
    task_id = 'preprocess_b2b_order_dtl_task',
    provide_context = True,
...
branch_skip_load_edw >> preprocess_b2b_order_dtl_task

b2b_order_dtl_src2stg_task = PythonOperator(
    task_id='b2b_order_dtl_src2stg_task',
    provide_context = True,
...
b2b_order_dtl_stg2ods_task = PythonOperator(
    task_id='b2b_order_dtl_stg2ods_task',
    provide_context = True,
...
# b2b_order_dtl_post_update = PythonOperator(
#     task_id='b2b_order_dtl_post_update',
#     provide_context = True,
...
b2b_order_dtl_updated_by_b2b_gwp_and_sku_map = PythonOperator(
    task_id='b2b_order_dtl_update_by_b2b_gwp_and_sku_map',
    provide_context = True,
    python_callable = update_downstream,
...
b2b_order_dtl_updated_by_product_info = PythonOperator(
    task_id='b2b_order_dtl_update_by_product_info',
    provide_context = True,
    python_callable = update_downstream,
    op_kwargs = {'myutil':myutil, 'gpdb': db, 'sql_file_name':"jd_b2b_order_dtl" , 'sql_section': 'update_by_product_info', 'args': args},
    on_failure_callback = dag_failure_handler,
...
b2b_order_dtl_updated_by_jd_member = PythonOperator(
    task_id='b2b_order_dtl_update_by_jd_member',
    provide_context = True,
    python_callable = update_downstream,
...
b2b_order_dtl_update_b2b_order = PythonOperator(
    task_id='b2b_order_dtl_update_b2b_order',
    provide_context = True,
    python_callable = update_downstream,
...
b2b_order_dtl_update_jd_member = PythonOperator(
    task_id='b2b_order_dtl_update_jd_member',
    provide_context = True,
    python_callable = update_downstream,
...
branch_skip_load_edw >> b2b_order_dtl_dummy >> b2b_order_dtl_update_jd_member

b2b_order_dtl_update_pop_order_dtl = PythonOperator(
    task_id='b2b_order_dtl_update_pop_order_dtl',
    provide_context = True,
    python_callable = update_downstream,
...
b2b_order_dtl_update_dl_order_dtl = PythonOperator(
    task_id='b2b_order_dtl_update_dl_order_dtl',
    provide_context = True,
    python_callable = update_downstream,
...
b2b_order_dtl_update_dl_order = PythonOperator(
    task_id='b2b_order_dtl_update_dl_order',
    provide_context = True,
    python_callable = update_downstream,
...
b2b_order_dtl_update_dl_shopper = PythonOperator(
    task_id='b2b_order_dtl_update_dl_shopper',
    provide_context = True,
    python_callable = update_downstream,
...
b2b_order_dtl_update_dly_sales_rpt = PythonOperator(
    task_id='b2b_order_dtl_update_dly_sales_rpt',
    provide_context = True,
    python_callable = update_downstream,
...
# b2b_order_dtl_update_mly_sales_rpt = PythonOperator(
#     task_id='b2b_order_dtl_update_mly_sales_rpt',
#     provide_context = True,
#     python_callable = update_downstream,
...
b2b_order_dtl_sync_2_rds_task = SubDagOperator(
    task_id='b2b_order_dtl_sync_2_rds_task',
    subdag=sync_subdag(DAG_NAME, 'b2b_order_dtl_sync_2_rds_task', myutil, entity_conf, args, entity),
    default_args=args,
...
postprocess_b2b_order_dtl_task = PythonOperator(
    task_id = 'postprocess_b2b_order_dtl_task',
    provide_context = True,
...
preprocess_b2b_order_dtl_task >> b2b_order_dtl_src2stg_task >> b2b_order_dtl_stg2ods_task >>  b2b_order_dtl_ods2edw_task 
b2b_order_dtl_ods2edw_task >> b2b_order_dtl_update_jd_member >> b2b_order_dtl_updated_by_b2b_gwp_and_sku_map >> b2b_order_dtl_updated_by_product_info >> b2b_order_dtl_updated_by_jd_member 
b2b_order_dtl_updated_by_jd_member >> b2b_order_dtl_update_pop_order_dtl >> b2b_order_dtl_update_dl_order_dtl
b2b_order_dtl_update_dl_order_dtl >> b2b_order_dtl_update_dl_shopper >> b2b_order_dtl_sync_2_rds_task
b2b_order_dtl_update_dl_order_dtl >> b2b_order_dtl_update_dly_sales_rpt  >> b2b_order_dtl_sync_2_rds_task
# b2b_order_dtl_update_dl_order_dtl >> b2b_order_dtl_update_mly_sales_rpt  >> b2b_order_dtl_sync_2_rds_task
b2b_order_dtl_update_dl_order_dtl >> b2b_order_dtl_update_b2b_order >> b2b_order_dtl_update_dl_order >> b2b_order_dtl_sync_2_rds_task
b2b_order_dtl_sync_2_rds_task >> postprocess_b2b_order_dtl_task
