...
entity = 'pop_order_dtl'
src_entity = 'jd_pop_order_dtl'
DAG_NAME = 'jd_pop_order_dtl_dag'
...
def b_choice(**kwargs):
    if ("skip_load"  in kwargs.get('dag_run').conf 
        ...
        return "preprocess_pop_order_dtl_task"
...
branch_skip_load_pop_order_dtl = BranchPythonOperator(
    task_id='branch_skip_load_pop_order_dtl',
...
preprocess_pop_order_dtl_task = PythonOperator(
    task_id = 'preprocess_pop_order_dtl_task',
    provide_context = True,
...
pop_order_dtl_src2stg_task = PythonOperator(
    task_id='pop_order_dtl_src2stg_task',
    provide_context = True,
...
pop_order_dtl_stg2ods_task = PythonOperator(
    task_id='pop_order_dtl_stg2ods_task',
    provide_context = True,
...
pop_order_dtl_ods2edw_task = PythonOperator(
    task_id='pop_order_dtl_ods2edw_task',
    provide_context = True,
...
pop_order_dtl_update_jd_order = PythonOperator(
    task_id='pop_order_dtl_update_jd_order',
    provide_context = True,
...
pop_order_dtl_updated_by_pop_order = PythonOperator(
    task_id='pop_order_dtl_updated_by_pop_order',
    provide_context = True,
    python_callable = update_downstream,
    op_kwargs = {'myutil':myutil, 'gpdb': db, 'sql_file_name':"jd_pop_order_dtl" , 'sql_section': 'update_by_pop_order', 'args': args},
    on_failure_callback = dag_failure_handler,
    trigger_rule='none_failed',
    dag=dag,
)

pop_order_dtl_updated_by_pop_order_1 = PythonOperator(
    task_id='pop_order_dtl_updated_by_pop_order_1',
    provide_context = True,
    python_callable = update_downstream,
    op_kwargs = {'myutil':myutil, 'gpdb': db, 'sql_file_name':"jd_pop_order_dtl" , 'sql_section': 'update_by_pop_order', 'args': args},
    on_failure_callback = dag_failure_handler,
...
pop_order_dtl_updated_by_jd_pop_gwp_and_sku_map = PythonOperator(
    task_id='pop_order_dtl_updated_by_jd_pop_gwp_and_sku_map',
    provide_context = True,
    python_callable = update_downstream,
    op_kwargs = {'myutil':myutil, 'gpdb': db, 'sql_file_name':"jd_pop_order_dtl" , 'sql_section': 'update_by_jd_pop_gwp_and_sku_map', 'args': args},
    on_failure_callback = dag_failure_handler,
    dag=dag,
)

pop_order_dtl_updated_by_product_info = PythonOperator(
    task_id='pop_order_dtl_updated_by_product_info',
    provide_context = True,
    python_callable = update_downstream,
...
pop_order_dtl_updated_by_jd_member = PythonOperator(
    task_id='pop_order_dtl_updated_by_jd_member',
    provide_context = True,
    python_callable = update_downstream,
...
pop_order_dtl_update_dl_shopper = PythonOperator(
    task_id='pop_order_dtl_update_dl_shopper',
    provide_context = True,
    python_callable = update_downstream,
...
pop_order_dtl_update_dl_order_dtl = PythonOperator(
    task_id='pop_order_dtl_update_dl_order_dtl',
    provide_context = True,
    python_callable = update_downstream,
...
pop_order_dtl_update_dl_order = PythonOperator(
    task_id='pop_order_dtl_update_dl_order',
    provide_context = True,
    python_callable = update_downstream,
...
pop_order_dtl_update_dly_sales_rpt = PythonOperator(
    task_id='pop_order_dtl_update_dly_sales_rpt',
    provide_context = True,
    python_callable = update_downstream,
...
# pop_order_dtl_update_mly_sales_rpt = PythonOperator(
#     task_id='pop_order_dtl_update_mly_sales_rpt',
#     provide_context = True,
#     python_callable = update_downstream,
...
pop_order_dtl_sync_2_rds_task = SubDagOperator(
    task_id='pop_order_dtl_sync_2_rds_task',
    subdag=sync_subdag(DAG_NAME, 'pop_order_dtl_sync_2_rds_task', myutil, entity_conf, args, entity),
    default_args=args,
...
postprocess_pop_order_dtl_task = PythonOperator(
    task_id = 'postprocess_pop_order_dtl_task',
    provide_context = True,
...
branch_skip_load_pop_order_dtl >> pop_order_dtl_dummy >> pop_order_dtl_updated_by_pop_order
branch_skip_load_pop_order_dtl >> preprocess_pop_order_dtl_task
preprocess_pop_order_dtl_task >> pop_order_dtl_src2stg_task >> pop_order_dtl_stg2ods_task >> pop_order_dtl_ods2edw_task 
pop_order_dtl_ods2edw_task >> pop_order_dtl_updated_by_pop_order >> pop_order_dtl_updated_by_jd_pop_gwp_and_sku_map >> pop_order_dtl_updated_by_product_info 
pop_order_dtl_updated_by_product_info >> pop_order_dtl_updated_by_pop_order_1>> pop_order_dtl_updated_by_jd_member >> pop_order_dtl_update_jd_order
pop_order_dtl_update_jd_order >> pop_order_dtl_update_dl_order >> pop_order_dtl_sync_2_rds_task >> postprocess_pop_order_dtl_task
pop_order_dtl_updated_by_jd_member >> pop_order_dtl_update_dl_order_dtl
# pop_order_dtl_update_dl_order_dtl >> pop_order_dtl_update_mly_sales_rpt >> pop_order_dtl_sync_2_rds_task >> postprocess_pop_order_dtl_task
pop_order_dtl_update_dl_order_dtl >> pop_order_dtl_update_dly_sales_rpt >> pop_order_dtl_sync_2_rds_task >> postprocess_pop_order_dtl_task
pop_order_dtl_update_dl_order_dtl >> pop_order_dtl_update_dl_shopper >> pop_order_dtl_sync_2_rds_task >> postprocess_pop_order_dtl_task
pop_order_dtl_sync_2_rds_task >> postprocess_pop_order_dtl_task
