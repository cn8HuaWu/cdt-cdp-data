...
entity = 'store_coupon'
src_entity = 'phy_store_coupon'
DAG_NAME = 'phy_store_coupon_dag'
...
api_interval = Variable.get('interval_phy_store_coupon').strip()
...
def load_ods2edw(**kwargs):
    ...
    #
    my_batch_date = kwargs['task_instance'].xcom_pull(key='batch_date', task_ids='phy_store_coupon_stg2ods_task')
...
args = {
    ...
    'retries': 0,
    "src_name": SRC_NAME,
    "batch_date_args": 'phy_store_coupon_stg2ods_task',
}
...
phy_store_coupon_stg2ods_task = PythonOperator(
    task_id='phy_store_coupon_stg2ods_task',
...
phy_store_coupon_ods2edw_task = PythonOperator(
    task_id='phy_store_coupon_ods2edw_task',
    provide_context = True,
...
postprocess_phy_store_coupon_task = PythonOperator(
    task_id = 'postprocess_phy_store_coupon_task',
    provide_context = True,
...
phy_store_coupon_stg2ods_task >>  phy_store_coupon_ods2edw_task >> postprocess_phy_store_coupon_task